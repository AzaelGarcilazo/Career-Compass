...
public class AzureCognitiveServiceImpl implements AzureCognitiveService {
    ...
    public Map<String, Object> analyzePersonality(Map<String, Object> responses) {
        // Combinar todas las respuestas en un texto
        StringBuilder combinedText = new StringBuilder();
        for (Map.Entry<String, Object> entry : responses.entrySet()) {
            combinedText.append(entry.getValue().toString()).append(". ");
        }

        // Realizar análisis de sentimientos y extracción de frases clave
        ...
        // Transformar resultados a dimensiones de personalidad
    ...
    private Map<String, Object> transformToPersonalityDimensions(
        ...
        // Extraer el sentimiento general
        ...
        // Calcular dimensiones de personalidad basadas en análisis
    ...
    private double extractSentimentScore(Map<String, Object> sentimentResult) {
        try {
            ...
            if (documents != null && !documents.isEmpty()) {
                ...
                // Calcular score general: positivo contribuye +1, negativo -1, neutral 0
    ...
    private Map<String, Double> calculatePersonalityDimensions(
        ...
        // CONSCIENTIOUSNESS (Responsabilidad) - basado en palabras relacionadas con orden/planificación
        ...
        // EXTRAVERSION (Extroversión) - basado en sentimiento positivo y palabras sociales
        ...
        // AGREEABLENESS (Amabilidad) - basado en sentimiento y palabras de cooperación
        ...
        // NEUROTICISM (Neuroticismo) - basado en sentimiento negativo
    ...
    private String generatePersonalityDescription(Map<String, Double> dimensions) {
        ...
        // Generar descripción basada en las dimensiones más altas
        if (openness > 70) {
    ...
    private List<String> identifyKeyTraits(Map<String, Double> dimensions) {
        ...
        // Identificar los 3 rasgos más prominentes
